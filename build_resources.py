...
COMMANDS = [
    [
        ...
        "-p", PYTHON_ENV,
        "-py", "python/tank/authentication/ui",
        "-q", "python/tank/authentication/resources",
        "-uf", "login_dialog",
        "-rf", "resources",
        "-i", ".qt_abstraction"
    ],
    [
        "tk-build-qt-resources",
        "-p", PYTHON_ENV,
        "-py", "python/tank/platform/qt",
        "-q", "python/tank/platform/qt",
        "-uf", "tank_dialog", "item", "busy_dialog",
        "-ufn", "ui_tank_dialog", "ui_item", "ui_busy_dialog",
        "-rf", "resources",
        "-i", "."
    ]
]
...
if __name__ == "__main__":
    install_package("git+https://github.com/shotgunsoftware/tk-toolchain.git#egg=tk-toolchain")
    run_commands()
