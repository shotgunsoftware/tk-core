...
"background-color: rgb(35, 165, 225);")
        ...
        self.widget = QtGui.QWidget(self._2fa_page)
...
"background-color: rgb(35, 165, 225);")
        ...
        self.button_layout_2.setStretch(0, 1)
        ...
        self.widget_3 = QtGui.QWidget(self.backup_page)
        ...
        self.backup_message = QtGui.QLabel(self.backup_page)
        self.backup_message.setWordWrap(True)
        self.backup_message.setObjectName("backup_message")
        self.verticalLayout_6.addWidget(self.backup_message)
        self.button_layout_3 = QtGui.QHBoxLayout()
        self.button_layout_3.setSpacing(10)
        self.button_layout_3.setContentsMargins(5, -1, -1, -1)
        ...
        self.use_google_app = QtGui.QPushButton(self.backup_page)
        self.use_google_app.setAutoDefault(False)
        self.use_google_app.setFlat(True)
        self.use_google_app.setObjectName("use_google_app")
        self.button_layout_3.addWidget(self.use_google_app)
        self.verity_backup = QtGui.QPushButton(self.backup_page)
        self.verity_backup.setStyleSheet("color: rgb(248, 248, 248);\n"
"background-color: rgb(35, 165, 225);")
        self.verity_backup.setAutoDefault(False)
        self.verity_backup.setDefault(True)
        self.verity_backup.setFlat(True)
        self.verity_backup.setObjectName("verity_backup")
        self.button_layout_3.addWidget(self.verity_backup)
        self.button_layout_3.setStretch(0, 1)
    ...
    def retranslateUi(self, LoginDialog):
        ...
        self._2fa_message.setText(QtGui.QApplication.translate("LoginDialog", "Enter the code that you received in the Google Authenticator app.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.backup_message.setText(QtGui.QApplication.translate("LoginDialog", "Enter one of your backup codes.", None, QtGui.QApplication.UnicodeUTF8))
        self.cancel_backup.setText(QtGui.QApplication.translate("LoginDialog", "Cancel", None, QtGui.QApplication.UnicodeUTF8))
        self.use_google_app.setText(QtGui.QApplication.translate("LoginDialog", "Use Google App", None, QtGui.QApplication.UnicodeUTF8))
        self.verity_backup.setText(QtGui.QApplication.translate("LoginDialog", "Verify", None, QtGui.QApplication.UnicodeUTF8))
