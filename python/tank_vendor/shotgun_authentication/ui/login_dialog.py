...
"}")
        ...
        self.stackedWidget.setMinimumSize(QtCore.QSize(86, 0))
...
"background-color: rgb(35, 165, 225);")
        ...
        self.credentials_2.setMinimumSize(QtCore.QSize(0, 126))
...
"background-color: rgb(35, 165, 225);")
        ...
        self.credentials_3.setMinimumSize(QtCore.QSize(0, 126))
        ...
        self._2fa_message_2 = QtGui.QLabel(self.backup_page)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self._2fa_message_2.setMargin(4)
        self._2fa_message_2.setObjectName("_2fa_message_2")
        self.verticalLayout_6.addWidget(self._2fa_message_2)
