...
def get_from_location_and_paths(
    app_or_engine, pc_path, bundle_install_path, location_dict
):
    """
    Factory method.
    ...
    return create_descriptor(
        sg_connection, new_descriptor_type, location_dict, bundle_install_path
    )
