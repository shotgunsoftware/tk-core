...
class IODescriptorAppStore(IODescriptorDownloadable):
    ...
    def get_latest_version(self, constraint_pattern=None):
        ...
        if constraint_pattern:
            ...
            log.debug(f"MATCHING_RECORDS, {matching_records} records remain.")
            ...
            for candidate in matching_records:
                ...
                try:
                    ...
                    log.debug(f"MANIFEST_DATA APPSTORE= {manifest}")
            ...
            if sg_data_for_version is None:
                ...
                sg_data_for_version = (
                    None  # We'll create descriptor without refreshing metadata
                )
