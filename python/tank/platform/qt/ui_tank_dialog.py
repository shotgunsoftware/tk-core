...
"margin-top: 5px;")
        ...
        self.app_icon = QtGui.QLabel(self.tab)
        ...
        self.app_name = QtGui.QLabel(self.tab)
...
"")
        ...
        self.app_description = QtGui.QLabel(self.tab)
        ...
        self.verticalLayout_7.addWidget(self.app_description)
        self.app_tech_details = QtGui.QLabel(self.tab)
...
"margin-top: 30px;")
        ...
        self.app_work_area_info = QtGui.QLabel(self.tab)
        ...
        self.verticalLayout_7.addWidget(self.app_work_area_info)
        self.horizontalLayout_10 = QtGui.QHBoxLayout()
        self.horizontalLayout_10.setSpacing(2)
        self.horizontalLayout_10.setObjectName("horizontalLayout_10")
        self.btn_file_system = QtGui.QToolButton(self.tab)
        self.btn_file_system.setObjectName("btn_file_system")
        self.horizontalLayout_10.addWidget(self.btn_file_system)
        self.btn_shotgun = QtGui.QToolButton(self.tab)
...
"}")
        ...
        self.verticalLayout_5.addLayout(self.config_layout)
        self.horizontalLayout_8 = QtGui.QHBoxLayout()
        self.horizontalLayout_8.setObjectName("horizontalLayout_8")
        self.btn_reload = QtGui.QToolButton(self.page2_scrollcontents)
        self.btn_reload.setObjectName("btn_reload")
        self.horizontalLayout_8.addWidget(self.btn_reload)
        self.btn_edit_config = QtGui.QToolButton(self.page2_scrollcontents)
        self.btn_edit_config.setObjectName("btn_edit_config")
        self.horizontalLayout_8.addWidget(self.btn_edit_config)
        self.btn_add_parameter = QtGui.QToolButton(self.page2_scrollcontents)
        self.btn_add_parameter.setObjectName("btn_add_parameter")
        self.horizontalLayout_8.addWidget(self.btn_add_parameter)
        ...
        self.verticalLayout_6.addWidget(self.page2_scroll)
