...
"}")
        ...
        self.logo = AspectPreservingLabel(self.credentials)
...
"background-color: rgb(35, 165, 225);")
        ...
        self.verticalLayout_8 = QtGui.QVBoxLayout(self.web_page)
        self.verticalLayout_8.setSpacing(-1)
        self.verticalLayout_8.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_8.setObjectName("verticalLayout_8")
        self.verticalLayout_web = QtGui.QVBoxLayout()
        self.verticalLayout_web.setSpacing(10)
        self.verticalLayout_web.setObjectName("verticalLayout_web")
        self.webView = QtWebKit.QWebView(self.web_page)
        self.webView.setUrl(QtCore.QUrl("about:blank"))
        self.webView.setObjectName("webView")
        self.verticalLayout_web.addWidget(self.webView)
        self.button_layout_web = QtGui.QHBoxLayout()
        self.button_layout_web.setSpacing(10)
        self.button_layout_web.setObjectName("button_layout_web")
        self.pushButton = QtGui.QPushButton(self.web_page)
        self.pushButton.setStyleSheet("color: rgb(248, 248, 248);\n"
"background-color: rgb(35, 165, 225);")
        self.pushButton.setObjectName("pushButton")
        self.button_layout_web.addWidget(self.pushButton)
        spacerItem6 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.button_layout_web.addItem(spacerItem6)
        self.verticalLayout_web.addLayout(self.button_layout_web)
        self.verticalLayout_web.setStretch(0, 1)
        self.verticalLayout_8.addLayout(self.verticalLayout_web)
    ...
    def retranslateUi(self, LoginDialog):
        ...
        self.pushButton.setText(QtGui.QApplication.translate("LoginDialog", "Back", None, QtGui.QApplication.UnicodeUTF8))
