...
This can be a problem for programs not started by the Flow Production Tracking or if
the Flow Production Tracking is closed after. When the program attemps to authenticate
...
At this time, only the Flow Production Tracking and Shotgun Create fully support the
...
# Flow Production Tracking and Shotgun Create.
