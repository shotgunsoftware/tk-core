...
def resolve_publish_path(tk, sg_publish_data):
    ...
    **Published File Path Resolution**
    ...
    For more information on the published file path resolution, see our `Admin Guide <https://support.shotgridsoftware.com/hc/en-us/articles/115000067493#Configuring%20published%20file%20path%20resolution>`_.
